class FunctionsController < ApplicationController
  ...
  private
    ...
    def function_params
      params.require(:function).permit(:appointment_date, :start_time, :end_time, :allocated_at, :work_id, :work_time, :customer_id, :hire_car_id, :direct_contact, :customer_service_agreement, :data_privacy_statement)
    end
end
